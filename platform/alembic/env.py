"""
Alembic environment configuration for MedAI Platform.

Supports async PostgreSQL via asyncpg.
Reads DATABASE_URL from platform config when available,
...
# Try to override URL from app config (env var DATABASE_URL)
try:
